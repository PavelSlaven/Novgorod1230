    ...
    const response = await roleRunner.run({
        ...
        messages: [{
          ...
          content: [
            ...
            'Return interpretation, resolution, direct_result_kind, operation_family, operation_choice or operations, check, continuation, clarification, reason_code, reason. No analysis or alternatives; if mistaken, emit corrected final JSON.',
