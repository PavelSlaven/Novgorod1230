...
- в начале нового спринта (новый milestone в [CURRENT_SPRINT](../work/CURRENT_SPRINT.md));
...
1. Работать от свежего `origin/main` в отдельной ветке; одна задача = новая сессия ([WORKFLOW](WORKFLOW.md)).
