...
if (report.target.contracts.length !== 213 || report.target.errors.length !== 82) throw new Error('Current 4.4 target totals changed');
...
console.log('P07 non-vocabulary checks passed: historical P05 160/58 preserved; current 4.4 has 213 validators, 82 typed errors and Appendix A state machines.');
