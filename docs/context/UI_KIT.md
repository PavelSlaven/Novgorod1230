...
| Файл в `apps/*/src` — ориентир 300 строк и 25 КБ | check-boundaries: превышение размера/строк → `warnings`, не hard fail ([check-boundaries.mjs](../../tools/architecture/check-boundaries.mjs)) |
