...
admission class полного candidate с qualifiers/relations. Явные `no_change` и
`authority_required` сохраняются до classification и ничего не admit-ят;
для остальных verdict при несовпадении с
