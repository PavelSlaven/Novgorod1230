...
> Исторический журнал: приведённые команды npm относятся к состоянию репозитория на момент записи. Актуальные команды — в [каталоге](../../../generated/npm-script-catalog.md).
