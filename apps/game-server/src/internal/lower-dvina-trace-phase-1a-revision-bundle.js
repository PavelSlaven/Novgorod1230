...
import { loadLowerDvinaTraceRevision35Bundle } from './lower-dvina-trace-revision-35-bundle.js';
import {
...
export async function loadLowerDvinaTraceRevisionBundle({
  ...
  const revision22 = async () => loadLowerDvinaTraceRevision22Bundle({
    rootDir, historicalBundle: await revision21(), fail, freezeDeep,
    validateDefinitionPins });
  if (scenarioDefinitionRevision === 22) return revision22();
  if (scenarioDefinitionRevision === 23) return loadLowerDvinaTraceRevision23Bundle({
    rootDir, historicalBundle: await revision22(), fail, freezeDeep,
    validateDefinitionPins });
  if (scenarioDefinitionRevision === 24) return loadLowerDvinaTraceRevision24Bundle({
  ...
  if (scenarioDefinitionRevision === 25) return loadLowerDvinaTraceRevision25Bundle({
  ...
  if (scenarioDefinitionRevision === 34) return loadLowerDvinaTraceRevision34Bundle({
    rootDir, historicalBundle: await loadLowerDvinaTraceRevisionBundle({
      ...
      freezeDeep, validateDefinitionPins }), fail, freezeDeep,
    validateDefinitionPins });
  if (scenarioDefinitionRevision === 35) return loadLowerDvinaTraceRevision35Bundle({
    rootDir, historicalBundle: await loadLowerDvinaTraceRevisionBundle({
      scenarioDefinitionRevision: 34, rootDir, loadRevision7Bundle, fail,
      freezeDeep, validateDefinitionPins }), fail, freezeDeep,
    validateDefinitionPins });
  fail(
