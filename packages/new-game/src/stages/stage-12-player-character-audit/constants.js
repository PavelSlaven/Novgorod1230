...
export const PLAYER_AUDIT_ALLOWED_CONCERN_CODES = Object.freeze(new Set([
  ...
  'TRACE_PLAYER_PROFILE_POLICY_INVALID',
  'TRACE_PLAYER_PROFILE_CANDIDATE_SET_EMPTY',
  'TRACE_PLAYER_PROFILE_ROLE_MISMATCH',
  'TRACE_PLAYER_PROFILE_OCCUPATION_MISMATCH',
  'TRACE_PLAYER_PROFILE_DEFINITION_REF_MISMATCH',
  'TRACE_PLAYER_PROFILE_REF_MISMATCH',
  'TRACE_PLAYER_PROFILE_NAME_NOT_APPROVED',
  'TRACE_PLAYER_PROFILE_ATTRIBUTES_NOT_EXACT',
  'TRACE_PLAYER_PROFILE_ATTRIBUTE_MISMATCH',
  'TRACE_PLAYER_PROFILE_SKILLS_NOT_EXACT',
  'TRACE_PLAYER_PROFILE_SKILL_MISMATCH',
  'TRACE_PLAYER_PROFILE_SKILL_BASIS_MISSING',
  'TRACE_PLAYER_PROFILE_ABSENCE_BASIS_MISSING',
  'TRACE_PLAYER_PROFILE_SKILL_BASIS_MISMATCH',
  'TRACE_PLAYER_PROFILE_ABSENCE_BASIS_MISMATCH',
  'TRACE_PLAYER_PROFILE_BASIS_FIELD_INVALID'
]));
