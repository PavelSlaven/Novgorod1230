...
- catalog bundle имеет обязательные digest, world revision, region, period, regional permission, normalized source refs, passed readiness report и замкнутые internal profile/template/rule references; non-approved или revision-mismatched runtime record является hard block;
