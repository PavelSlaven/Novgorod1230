...
|---|---|---|
| `@rus/space-map` | пакет в дереве; runtime не импортирует; удаление — [#133](https://github.com/PavelSlaven/Novgorod1230/issues/133#issuecomment-5837624476) п.6 | do not treat as runtime owner |
