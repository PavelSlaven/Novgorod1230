...
| `@rus/party-store` | `packages/party-store` | party persistence contract; idempotency key и committed-result semantics; Stage 25 persistence port | `./src/index.js` | `@rus/contracts`, `@rus/kernel` |
