...
export function buildOrdinaryMaterializationMessages(request, { repair = null,
  ...
  if (isAbsentPresence && responseShape != null) {
    instructions.push('Return exactly {"resolution":"absent","reason_code":"absent"}.');
      ...
      'A search for an otherwise unspecified object defined by an evidentiary, clue, official, or hidden role is authority-constrained rather than an ordinary situation question: classify the full restricted role and return authority_required, never no_change or a fabricated item.',
