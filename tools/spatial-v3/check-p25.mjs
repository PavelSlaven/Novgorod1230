...
for (const token of ['P25 compatibility and deprecation record', 'request_profiles', 'bindSpatialV3RequestProfile', 'production_v2', 'shadow_v3', 'versioned production activation', 'p25-compatibility-cutover.test.js']) if (!adr.includes(token)) throw new Error(`P25 ADR record lacks ${token}`);
