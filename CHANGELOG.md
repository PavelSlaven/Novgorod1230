...
- feat(knowledge-source): lexical-only normative RAG; status/priority_tier from CONTRACT_INDEX; `reference` status for UNDECLARED/guides (#144, PR #150) LW-008 updated
