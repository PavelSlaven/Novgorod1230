    ...
    const response = await roleRunner.run({
        ...
        messages: [{
          ...
          content: [
            ...
            'Adjacent current-scene looking, listening, smelling, or other player-safe perception clauses that require no code-owned operation and no check may form one direct player_safe_observation step. Preserve a later speech, movement, manipulation, or other independently consequential action in continuation. A purpose, hope, manner, or expected-result clause belongs to the action it qualifies and is not a separate executable continuation.',
