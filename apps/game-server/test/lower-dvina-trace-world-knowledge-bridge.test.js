...
test('WK materialization substrate covers real trace location and participant premise families', async () => {
  ...
  const probes = [
    ...
    { family: 'storage_context', location: 'trace_ld_v1_loc_zhdanko_storehouse',
      domains: ['architecture_settlement', 'material_culture', 'biology_physiology'],
      hints: ['household', 'storage', 'vessels'],
      expected_claim_refs: ['claim:population-household-storage',
        'claim:population-storage-vessels'] },
    { family: 'stored_grain_condition', location: 'trace_ld_v1_loc_zhdanko_storehouse',
      domains: ['architecture_settlement', 'material_culture', 'biology_physiology'],
      hints: ['grain', 'storage', 'temperature', 'moisture'],
      expected_claim_refs: ['claim:stored-grain-condition-depends-on-temperature-moisture'] },
