...
> **Статус: historical.** Документ фиксирует baseline
> `66864e751ce594888c792e7061f08ca4bf857592` до реализации нового vertical
> slice. Описанные ниже gaps закрывались последующими Phase 0–11; утверждения о
> том, что сценарий ещё не реализован и следующей должна быть Phase 0, не
> относятся к текущему production. Актуальное состояние см. в
> [reference](lower-dvina-trace-reference.md), историю реализации — в
