...
export const TURN_STEP_PLANNER_INSTRUCTIONS = [
  ...
  'Choose make_believe when the stated goal depends on a fantastical referent absent from player-safe state; choose reality_limited only for a real present attempt limited by physical capability.',
