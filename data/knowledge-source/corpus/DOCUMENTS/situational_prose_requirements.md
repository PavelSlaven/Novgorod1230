...
Слабая литературная проза блокирует приёмку этапа (решение владельца, [#133](https://github.com/PavelSlaven/Novgorod1230/issues/133#issuecomment-5836830425) п.4): этап M2c / художественная приёмка не принимаются при `artistic_verdict: fail` или `NARRATOR_PROSE_WEAK_LITERARY_COMPOSITION` на обязательных сценах приёмки. Это норма приёмки этапа, а не разрешение narrator выдумывать факты.
