...
- **Статус:** историческая карта реализации до revision 19 / `spatial-v3-production-v9`; текущие pins — `apps/game-server/MODULE.md`
...
| Appearance | Единый actor appearance contract, real equipped garments и read-time portrait projection. | revision 19 / v9 | actors, materialization, items-property, visibility, contracts | identity/item snapshots; `portrait_spec_v1` не сохраняется | PR [#72](https://github.com/PavelSlaven/Novgorod1230/pull/72) |
...
Lower Dvina progression. Historical revision 19 / `spatial-v3-production-v9`
