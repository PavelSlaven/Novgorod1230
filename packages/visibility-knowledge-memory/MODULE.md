...
- Владеет bounded actor-context selection: сохраняет раннее обязательство,
  первый causal record и recent tail, не превращая производный срез в truth.
