...
function isCombatBranchPoint(manifest, index) { return manifest[index]?.scenario_class === 'combat' && manifest[index + 1]?.scenario_class !== 'combat'; }
