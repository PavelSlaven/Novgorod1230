...
export const TABLES = Object.freeze({
  ...
  party_materialization_runs: { modes: ['append'], key: ['party_id', 'run_id'] },
  party_materialization_choices: { modes: ['append'], key: ['party_id', 'run_id', 'choice_ordinal'] },
  party_ordinary_materialization_aggregates: { modes: ['insert'], key: ['party_id', 'scope_kind', 'scope_id'] },
  party_ordinary_materialization_contexts: { modes: ['insert'], key: ['party_id', 'scope_kind', 'scope_id'] },
  party_ordinary_materialization_basis_catalog: { modes: ['insert'], key: ['party_id', 'scope_kind', 'scope_id', 'basis_ref'] },
  party_ordinary_materialization_enablements: { modes: ['insert'], key: ['party_id', 'scope_kind', 'scope_id'] },
  ...
  expansion_frontiers: { modes: ['insert', 'update'], key: ['id'], version: true },
  expansion_capacity_reservations: { modes: ['insert', 'update'], key: ['id'], version: true },
  party_continuation_chains: { modes: ['insert', 'update'], key: ['id'], version: true },
  party_g4_expansion_ledgers: { modes: ['insert', 'update'], key: ['party_id', 'g4_id', 'profile_ref_id'], version: true },
  scene_frontier_bindings: { modes: ['insert', 'update'], key: ['id'], version: true },
  g5_site_connections: { modes: ['insert'], key: ['id'] },
  party_site_connection_endpoint_bindings: { modes: ['insert'], key: ['id'] },
