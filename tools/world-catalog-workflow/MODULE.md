...
- публичными `assessTravelProfileReadiness` и `assessEnvironmentFeatureReadiness`: чистой fail-closed проверкой approved, version/region/period-pinned travel и environment authoring-наборов, их DDL-derived bindings, runtime policy schemas и provenance. Они возвращают concerns и не создают runtime bundle или игровые данные.
