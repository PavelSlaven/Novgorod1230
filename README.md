...
`spatial-v3-production-v16` с `builtin:production-spatial-v3` и
`builtin:spatial-v3-production-v16`. Spatial v3 и Temporal World v4 —
...
решений NPC runtime v16 подмешивает компактный срез production World
