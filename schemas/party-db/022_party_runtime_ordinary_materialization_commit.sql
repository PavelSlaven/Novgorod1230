...
CREATE TABLE IF NOT EXISTS party_runtime.party_ordinary_materialization_items (
  ...
  CHECK (item_proposal ->> 'schema' = 'ordinary_world_item_proposal_v1'),
  CHECK (property_placement_evidence ->> 'schema' = 'rus.items.ordinary_world_property_placement_evidence.v2'),
