...
if (report.target.contracts.length !== 160 || report.target.errors.length !== 58) throw new Error('Frozen P05 target totals changed');
...
console.log('P07 checks passed: 160 schema/validator definitions, 13 closed vocabulary registries, 58 typed errors and Appendix A state machines.');
