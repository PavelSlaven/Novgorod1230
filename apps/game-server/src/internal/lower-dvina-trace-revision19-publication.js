...
export const TRACE_REVISION19_PHASE_1A_MANIFEST_DIGEST =
...
export async function loadLowerDvinaTraceRevision19Publication({
  rootDir = process.cwd(),
  phase1AManifestDigest = null
} = {}) {
  if (phase1AManifestDigest != null
      && phase1AManifestDigest !== TRACE_REVISION19_PHASE_1A_MANIFEST_DIGEST) {
  ...
  if (phase1a.digest !== TRACE_REVISION19_PHASE_1A_MANIFEST_DIGEST) {
