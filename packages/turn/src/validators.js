...
export function validateTurnWritePlan(value) {
  ...
  const allowedKeys = new Set(['version','schema','sealed_by','party_id','turn_id','base_state_version','write_targets','command_trace','turn_step_commit','first_entry_materialization','destination_position','ordinary_materialization_atomic_write_plan','action_production_atomic_write_plans']);
