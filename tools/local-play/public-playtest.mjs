...
function releaseManifestBranch(turn, branch) { if (branch == null) return null; if (turn.status < 200 || turn.status >= 300 || !turn.response?.turn_id || turn.response?.screen_status !== 'ready' || turn.presentation_pending === true) return false; return turn.response.option_id === branch.continue_option_id ? null : branch.alternate_outcome; }
