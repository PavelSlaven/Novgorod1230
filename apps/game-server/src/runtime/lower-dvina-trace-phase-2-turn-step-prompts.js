...
export const TURN_STEP_PLANNER_INSTRUCTIONS = [
  ...
  'Direct empty achieved or partially_achieved requires semantic moment/none and direct_result_kind: player_safe_item_observation for reviewing the identity, placement, or condition of supplied carried/worn items; player_safe_observation for other supplied sensory facts; otherwise no_state_gesture. Preserve uncertainty; never infer local state, cause, forecast, timing, new physical detail, or code-owned effects. Use perception or its owner for those.',
