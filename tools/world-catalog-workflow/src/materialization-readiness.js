...
export const MATERIALIZATION_FOREIGN_KEYS = Object.freeze([
  ...
  ['item_template_quantity_profiles','item_template_id','item_templates'], ['item_template_quantity_profiles','world_revision_id','world_revisions'], ['item_template_quantity_profiles','quantity_unit_id','quantity_unit_definitions'], ['item_template_quantity_profiles','source_id','source_records'],
