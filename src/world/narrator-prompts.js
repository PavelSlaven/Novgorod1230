  ...
  return [
    {
      ...
      content: buildVisibilityPromptHeader({
        ...
        constraints: 'Будущие delayed events без видимого следа не включай. Скрытые предметы в закрытых контейнерах не включай как объекты. Не создавай visible_npc и source_ref, если их нет в approved input.visibleNpcs.',
  ...
  return [
    {
      ...
      content: buildVisibilityPromptHeader({
        ...
        constraints: 'Типы из outputContract. Запрещены hidden, audit, dossier, state_delta в output. Не добавляй visible_npc/source_ref вне approved input.visibleNpcs.',
  ...
  return [
    {
      ...
      content: buildRepairPromptHeader({
        ...
        constraints: 'Не добавляй новых фактов; не раскрывай скрытые мотивы и будущие события. Не исправляй конфликт созданием нового visible_npc/source_ref.',
