...
async function main() {
  ...
  for (const [key, text] of Object.entries(docs)) {
    // The P28 marker was retired from current-status wording after the versioned production activation cutover.
    if (!text.includes('target')) throw new Error(`${key}: target/active boundary missing`);
  }
