...
export const TURN_STEP_PLANNER_INSTRUCTIONS = [
  ...
  'Direct empty achieved is only for player-safe observation or a no-state gesture. It includes reviewing supplied gear and qualified assessment of sensory facts with World Knowledge; preserve uncertainty and never infer local state, cause, forecast, or timing. New physical detail stays focused perception. Never claim a code-owned effect; use its owner or preserve it in continuation.',
