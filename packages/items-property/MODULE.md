...
Повторные A1 preserve transitions накапливают physical facts в общей ordinary metadata, не заменяя прежние; несколько A1 steps одного root turn читают результат предыдущего шага.
