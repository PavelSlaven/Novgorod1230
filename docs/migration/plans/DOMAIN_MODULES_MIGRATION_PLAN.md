...
New-game Stages 2–26 и общий orchestrator уже модульны. Следующая последовательная фаза нормативного плана — выделение владельцев доменных правил. Код не придумывает категории и факты: доменные модули принимают approved categories/templates/profiles/rules, проверяют инварианты, материализуют допустимые instances и применяют зафиксированные формулы.
