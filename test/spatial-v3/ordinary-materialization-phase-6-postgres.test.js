...
test('Phase 6 ordinary PostgreSQL committer is atomic, exact, replay-safe and stale-safe', async (t) => {
  ...
  await pool.query(await readFile('schemas/party-db/025_party_runtime_existing_container_ordinary_contents.sql', 'utf8'));
