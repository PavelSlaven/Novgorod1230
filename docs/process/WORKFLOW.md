...
1. разделы AGENTS.md по типу задачи (после PR2 — строка маршрутизации роутера) и применимая строка scope matrix
   CONTRACT_INDEX §8.1 со статусами документов из §2–§7 индекса;
