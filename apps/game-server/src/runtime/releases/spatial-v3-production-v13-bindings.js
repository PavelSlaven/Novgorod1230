...
import { createLowerDvinaTraceNpcAutonomousModel,
  createLowerDvinaTraceNpcCombatModel, createLowerDvinaTraceNpcSemanticModel,
...
export function createSpatialV3RuntimeBindings(context={}){
  if(context.release?.release_id!=='spatial-v3-production-v13'
    ...
    throw new TypeError('exact spatial-v3-production-v13 semantic release is required');
  return createSpatialV3ProductionBindings(context,{
    technicalCommandBoundary:'production-v13',createNpcRuntimePorts:({roleRunner})=>({
