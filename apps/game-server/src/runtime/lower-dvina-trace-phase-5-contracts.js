...
export function resolveTracePhase5Contracts({ state, bundle }) {
  if (![11, 12, 13, 14, 15, 16, 17, 18].includes(bundle.definition_revision)
      || ![11, 12, 13, 14, 15, 16, 17, 18].includes(bundle.definition?.revision)) {
  ...
  const ropeInventoryProfile = [12, 13, 14, 15, 16, 17, 18].includes(bundle.definition_revision)
