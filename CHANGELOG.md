...
- docs(governance): роутер ведёт World Knowledge через строку IDX §8.1 без особого случая §6/§10; WR §20 требует обновлять CONTRACT_INDEX в том же PR (#111, PR #PR) LW-009 closed
