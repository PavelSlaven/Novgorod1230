...
function readyFixture() {
  const recordsByTable = {
    ...
    container_templates: [{ id: 'container-template-1', world_revision_id: 'rev-1', region_id: 'region-1', category_id: 'category-1', capacity: 2, access_policy: policy, ...approved }],
