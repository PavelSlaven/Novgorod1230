...
- This closes the four P12 source/target authoring gaps only. The atomic P28 gate still requires its live exact-head required CI and merge/tag completion proof. Production is not activated and v2 remains the sole production composition.
