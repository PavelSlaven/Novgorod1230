...
A claim count or supported family does not prove that a whole domain is
covered. The current cartography retains 49 partial need records and their
supporting claims; new editorial support is linked without automatically
declaring the families complete. Their principal needs must support
concrete ordinary situations, not merely state that outcomes vary or that
a different code owner controls current state.

The independent reality-first rubric remains:

- Physical and Earth systems; living world and ecology.
- Human body, lifecycle, illness and practical care.
- Cognition, speech, names, literacy and skill transmission.
- Kinship, age/gender/status, household and public conduct.
- Institutions, law, economy, politics, war and external relations.
...
The v9 five-ends government claim was removed at `03cbfa4` because its
claimed 1019–1270 applicability was unsupported. Permitting reconstruction
