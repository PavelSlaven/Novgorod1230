# DOCUMENTS — contract and domain documentation

The canonical entry point is root [`AGENTS.md`](../../../../AGENTS.md).

Use [`CONTRACT_INDEX.md`](CONTRACT_INDEX.md) to determine:

- which documents are governing, active, proposed, migration-only, reference or superseded;
- which contract set applies to a subsystem;
- when the read-only Contract Auditor is mandatory;
- how conflicts and filename/status traps are resolved.
