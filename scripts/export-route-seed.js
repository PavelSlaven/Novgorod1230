...
const xlsxPath = path.join(root, 'infra/world-base/route_templates_scientific_v2_fixed.xlsx');
const outPath = path.join(root, 'infra/world-base/route_templates.seed.json');
...
FLOAT_COLS = {"default_movement_multiplier"}
...
for row_idx in range(1, max_row + 1):
    ...
    for key, val in raw.items():
        ...
        elif key in ("id", "slug", "title", "route_kind", "status", "confidence"):
...
if (result.status !== 0) {
  console.error(result.stderr || 'export-route-seed: python failed');
