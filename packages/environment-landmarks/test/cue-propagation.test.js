...
const records = Object.freeze({
  landmark_rules: [{ rule_id: 'ridge-rule', status: 'approved', min_count: 1, max_count: 1, template_ids: ['ridge-tree'], placement_types: ['g4_node'], required: true, weight: 1 }],
  landmark_templates: [{ template_id: 'ridge-tree', status: 'approved', category_id: 'environment_landmark.tree', public_label_key: 'tree', icon_key: 'tree', navigation_value: 'high', distinctiveness: 'high', recognition_difficulty: 'ordinary', weight: 1 }],
...
const digestPayload = { schema_version: 'environment-catalog.v1', world_revision_id: 'revision-1', region_id: 'region-1', historical_period_id: 'period-1', regional_permissions: ['region-1'], ...records };
