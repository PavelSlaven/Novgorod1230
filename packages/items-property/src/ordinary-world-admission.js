...
function propertyInputOf(value) { const v1=record(value,PROPERTY_INPUT_V1); if(v1)return v1; const v2=record(value,PROPERTY_INPUT_V2); return v2?.schema==='rus.items.ordinary_world_property_placement_context.v2'&&v2.version===2?v2:null; }
