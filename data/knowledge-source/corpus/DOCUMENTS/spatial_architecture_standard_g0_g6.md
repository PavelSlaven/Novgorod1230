...
Документ определяет действующую пространственную архитектуру после materialization v2. Он устраняет смешение масштаба, сцены, позиции и маршрута и задаёт единую реализационную модель:
