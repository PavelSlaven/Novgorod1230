...
function validateActionProduction(value, path, errors) {
  if (!strict(value, path, [
  ...
  validateActionProductionShape(value, path, errors);
}

function validateActionProductionShape(value, path, errors) {
  const descriptor = value.result_descriptor ?? {};
