...
export function finalizeResult(config, request, projection, clockAfter, proposals, timeSliceResults, processedBoundaryIds, dispositions, deferredCandidates, digests, stoppedAfterCurrentBatch = false) {
