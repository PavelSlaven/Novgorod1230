...
export async function applyOrdinaryMaterializationAtomicWritePlanInTransaction({
  ...
  if (plan.item != null
      && current.g5_anchor_id !== plan.item.runtime_placement.anchor_id) {
